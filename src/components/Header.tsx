...
import { Search, Facebook, Twitter, Youtube, Instagram, MessageCircle, Bookmark, Menu, X, Bell, Globe } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <>
      {/* Top Bar */}
      <div className="bg-gradient-to-r from-amber-900 via-amber-800 to-orange-800 text-white py-2 px-4 shadow-lg">
      ...
      <div className="bg-white shadow-xl border-b border-amber-100 sticky top-0 z-50 backdrop-blur-md bg-white/95">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-amber-800 via-orange-700 to-red-600 bg-clip-text text-transparent hover:scale-105 transition-transform duration-300 cursor-pointer">
                  Dristi2020.com
                </h1>
              </div>
            </div>
        ...
        {/* Navigation */}
        <div className="bg-gradient-to-r from-gray-50 via-amber-50 to-orange-50 border-t border-amber-100">
          <div className="max-w-7xl mx-auto px-4">
            <nav className="items-center space-x-1 py-3 overflow-x-auto scrollbar-hide">
              {navItems.map((item, index) => (
                <a 
                  key={index}
                  href="#" 
                  className="text-amber-700 hover:text-amber-900 hover:bg-white/70 px-4 py-2.5 rounded-full whitespace-nowrap font-medium transition-all duration-300 transform hover:scale-105 hover:-translate-y-0.5 shadow-sm hover:shadow-md backdrop-blur-sm"
                >
                  {item}
                </a>
              ))}
